package bluesteel42.farmstorageblocks.block;

import bluesteel42.farmstorageblocks.FarmStorageBlocks;
...
public class ModBlocks {
    ...
    private static Block registerCropBlock(String path, Function<AbstractBlock.Settings, Block> factory, MapColor mapColor) {
        ...
        final Identifier identifier = Identifier.of(FarmStorageBlocks.MOD_ID, path);
